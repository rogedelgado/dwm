...
static const char *fonts[]          = { "Product Sans:size=12", "NotoColorEmoji:pixelsize=16:antialias=true:autohint=true" };
...
static const char col1[]            = "#8FBCBB";
static const char col2[]            = "#4C566A";
...
// static const char *dmenucmd[] = { "dmenu_run", "-l", "7",  "-c",  "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col1, "-sf", col2, NULL };
